...
class Product extends Model
{
    ...
    public function getProductConditionLabelAttribute()
    {
        $labels = [
            ...
            'box_opened' => 'Box Opened (Brand New Just Box Open)',
        ];
