...
class ExpenseCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('expense_categories')->with('message', __('db.Data inserted successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('expense_categories')->with('message', __('db.Data updated successfully'));
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect('expense_categories')->with('message', __('db.Expense Category imported successfully'));
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_expense_category_data->is_active = false;
        $lims_expense_category_data->save();
        return redirect('expense_categories')->with('not_permitted', __('db.Data deleted successfully'));
    }
