                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control selectpicker">
                                                @if (auth()->user()->role_id < 3)
                                                    ...
                                                    <option value="2" {{ $lims_transfer_data->status == 1 ? 'selected' : '' }}>
                                                        {{ __('db.Pending') }}
                                                    </option>
                                                    <option value="3" {{ $lims_transfer_data->status == 1 ? 'selected' : '' }}>
                                                        {{ __('db.Sent') }}
                                                    </option>
                                                @else
                                                    ...
                                                    @endif
                                                    @if ($lims_transfer_data->status == 3)
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td><input type="number" class="form-control qty" name="qty[]" value="1" max="'+data[15]+'" required step="any"/></td>';
