                ...
                <div class="card-body">
                  ...
                  <form>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" placeholder="{{ __('db.Email Address') }}" class="form-control">
                    </div>
                    <div class="form-group">       
                      <label>Password</label>
                      <input type="password" placeholder="{{ __('db.Password') }}" class="form-control">
                    </div>
                    <div class="form-group">       
                ...
                <div class="card-body">
                  ...
                  <form class="form-horizontal">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input id="inputHorizontalSuccess" type="email" placeholder="{{ __('db.Email Address') }}" class="form-control form-control-success"><small class="form-text">Example help text that remains unchanged.</small>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2">Password</label>
                      <div class="col-sm-10">
                        <input id="inputHorizontalWarning" type="password" placeholder="{{ __('db.Password') }}" class="form-control form-control-warning"><small class="form-text">Example help text that remains unchanged.</small>
                      </div>
                    </div>
                    <div class="form-group row">       
                ...
                <div class="card-body">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input type="text" disabled="" placeholder="{{ __('db.Disabled input here') }}" class="form-control">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          <input type="text" placeholder="{{ __('db.Default input') }}" class="form-control">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <input type="text" placeholder="{{ __('db.Username') }}" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group">
