                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="customer-section">
                                        <div class="form-group">
                                            <label>{{__('db.Address')}} *</strong></label>
                                            <input type="text" name="address" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label>{{__('db.State')}}</strong></label>
                                            <input type="text" name="state" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>{{__('db.Country')}}</strong></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="customer-section">
                                        ...
                                        <div class="form-group">
                                            <label>{{__('db.Tax Number')}}</strong></label>
                                            <input type="text" name="tax_number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>{{__('db.City')}} *</strong></label>
