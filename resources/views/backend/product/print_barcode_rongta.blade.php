                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2">
                                    <strong>{{__('db.Print')}}: </strong>&nbsp;
                                    <strong><input type="checkbox" name="name" checked /> {{__('db.Product Name')}}</strong>&nbsp;
                                    <strong><input type="checkbox" name="price" checked/> {{__('db.Price')}}</strong>&nbsp;
                                    <strong><input type="checkbox" name="promo_price"/> {{__('db.Promotional Price')}}</strong>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
        ...
        if(paper_size != "0") {
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    // 36mm
                    if(paper_size == 36)
                        htmltext +='<td style="width:328px;height:110%;padding-left:50px;padding-bottom:70px;font-size:13px;vertical-align:middle;text-align:center">';
                    //24mm
